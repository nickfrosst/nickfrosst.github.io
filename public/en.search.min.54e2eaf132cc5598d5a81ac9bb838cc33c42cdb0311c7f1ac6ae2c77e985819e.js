...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f259ff7d2fb973d298f56cba9300d671c4652ea69ccbb47da9943a7e70cd6daf.js',function(){input.required=false;search();});}
